...
export const TOOLS_DATABASE: ToolEntry[] = [
  ...
  {
    id: 'youtube-script-generator', slug: 'youtube-script-generator', name: 'YouTube Script Generator', shortDescription: 'Generate viral YouTube video scripts with AI',
    longDescription: 'Our YouTube Script Generator creates complete, professional video scripts with hooks, structured sections, engagement-boost lines, CTAs, and retention-optimized writing. Choose from 8 video types, 7 tones, and 3 duration options. Supports English and Bangla languages. Includes script templates, estimated retention and engagement scores, and unlimited regeneration.',
    category: 'youtube-tools', icon: 'Film',
    metaTitle: 'YouTube Script Generator - Create Viral Video Scripts Free | CreatorBoost AI',
    metaDescription: 'Generate engaging YouTube video scripts instantly using AI. Free script generator with hooks, sections, CTAs, and retention-optimized writing. Supports Educational, Entertainment, Vlog, Tutorial, and more.',
    ...
    faqs: [
      { q: 'What is YouTube Script Generator?', a: 'A free AI-powered tool that creates complete YouTube video scripts with hooks, structured sections, CTAs, and engagement-optimized writing.' },
      { q: 'What video types are supported?', a: '8 types: Educational, Entertainment, Vlog, Review, Tutorial, Storytelling, Motivation, and Tech Video.' },
      { q: 'Can I choose the tone?', a: 'Yes! 7 tones available: Professional, Funny, Emotional, Dramatic, Informative, Engaging, and Viral.' },
      { q: 'What duration options are there?', a: 'Short (1-3 min), Medium (4-8 min), and Long (8-15 min).' },
      { q: 'Can I generate scripts in Bangla?', a: 'Yes, the tool supports both English and Bangla (বাংলা) scripts.' },
      { q: 'Are the scripts free to generate?', a: 'Yes! Generate unlimited scripts at no cost.' },
    ],
    relatedToolIds: ['youtube-title-generator', 'youtube-description-generator', 'youtube-tag-generator'],
    publishDate: '2026-03-15', featured: true, trending: true, popular: false, isNew: true,
  },
  {
